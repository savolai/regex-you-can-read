...
This here is a  repository to bring together all the parties interested in working on the design and the implementation of a new regex syntax and UI. 
...
I wish to keep the discussion constructive and find solutions together. Let's to keep the core vision alive but the idea is to do this together, and distribute decision making as much as makes sense. Let's embrace each other's ideas and be supportive of each other's learning. Yay!
